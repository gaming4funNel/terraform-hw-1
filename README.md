...
Ключ -auto-approve выполняет операции без проверки уже созданной инфраструктуры и действует с автоматическим согласием - это чревато ее уничтожением (полным или частичным). Полезен при создании инфраструктуры заново.
...
Согласно описанию, образ при destroy отсается.
